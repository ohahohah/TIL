---
search:
    keywords: ['intellij', 'debugging']
---

**TOC**
* [Intro](#intro)
* [Reference](#reference)
* [Intellij 기본 사용법](#intellij-기본-사용법)
    * [Code inspection](#code-inspection)
    * [Debugging](#debugging)
    * [들어가기 전 - mac 기본 단어 이동 shortcut](#들어가기-전---mac-기본-단어-이동-shortcut)
    * [shortcut - 자주 쓰이는 단축키 중심 정리 (Mac 10.5 )](#shortcut---자주-쓰이는-단축키-중심-정리-mac-105)
      * [최소한 이것만은 알아두자](#최소한-이것만은-알아두자)
      ...
      * [Refactoring](#refactoring)
        * [중복부분 Extraction - opt   cmd   V/P/M](#중복부분-extraction---opt--cmd--vpm)
          * [Rename / ReType](#rename--retype)
      * [plugin (내장기능 포함)](#plugin-내장기능-포함)
* [Error 정리](#error-정리)
